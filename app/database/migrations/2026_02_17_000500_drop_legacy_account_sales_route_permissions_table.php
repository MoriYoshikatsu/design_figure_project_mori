...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::hasTable('work_permission_catalog') && Schema::hasTable('work_permission_grants')) {
            /** @var WorkPermissionService $service */
            $service = app(WorkPermissionService::class);
            $service->syncCatalog();
            $service->migrateLegacySalesPermissionsToWork();
        }

        Schema::drop('account_sales_route_permissions');
    }
